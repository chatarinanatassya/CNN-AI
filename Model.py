...
class Model_CNN_IR:
    ...
    def create_architecture(self):
        ...
        model = tf.keras.Sequential([
            ...
            tf.keras.layers.Conv2D(34, kernel_size=(3, 3),activation='relu'),
            tf.keras.layers.MaxPooling2D(pool_size=(2, 2)),
            tf.keras.layers.Conv2D(28, kernel_size=(3, 3), activation='relu'),
            tf.keras.layers.MaxPooling2D(pool_size=(2, 2)),
            tf.keras.layers.Conv2D(18, kernel_size=(3, 3), activation='relu'),
    ...
    def train_model(self):
        self.history = self.model.fit(self.x_train, self.y_train, epochs=30, verbose=2)
